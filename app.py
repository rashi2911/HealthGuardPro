...
def final():
    ...
    my_model=pickle.load(open('F:\SEM 6\Minor-2\Disease-Detection-based-on-Symptoms-master\model_saved','rb'))
...
def treatment():
    ...
    workbook = openpyxl.load_workbook('F:\SEM 6\Minor-2\Disease-Detection-based-on-Symptoms-master\cure_minor.xlsx')
